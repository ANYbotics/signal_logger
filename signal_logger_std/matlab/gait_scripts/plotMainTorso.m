...
armX = logElements(idx_loco_centerFront_positionWorldToEEOriginInWorldFrame_x).data;
armY = logElements(idx_loco_centerFront_positionWorldToEEOriginInWorldFrame_y).data;

baseX = logElements(idx_loco_torso_measPositionWorldToBaseInWorldFrame_x).data;
baseY = logElements(idx_loco_torso_measPositionWorldToBaseInWorldFrame_y).data;

plot(armX, armY, 'color','r', 'linewidth', 2);
plot(baseX, baseY, 'color','b', 'linewidth', 2);
