...
class LogElementInterface
{
 public:
   ...
   */
  virtual void saveDataToLogFile(const signal_logger::vector_type<TimestampPair> & times, unsigned int noCollectDataCalls, LogFileType type = LogFileType::BINARY) = 0;
